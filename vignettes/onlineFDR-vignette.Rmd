...
of the FWER. One procedure, Alpha-saving, gives a uniform improvement to the
...
10: **AlphaSaving**
Implements the Alpha-saving algorithm for online FWER control, as proposed by
Tian & Ramdas (2019b). Alpha-saving is a uniformly more powerful method than
Alpha-spending, as it saves the significance level of a previous rejection.
Alpha-saving strongly controls the FWER for arbitrarily dependent p-values.
...
### Alpha-saving {#Alpha-saving}

The Alpha-saving procedure of Tian & Ramdas (2019b) provides a uniformly more
powerful method than Alpha-spending, by saving the significance level of a
previous rejection. More specifically, Alpha-saving tests hypothesis $H_i$ at
...
Alpha-spending and Alpha-saving also control the FWER and FDR for arbitrarily
dependent p-values.
...
### Alpha-spending and Alpha-saving
