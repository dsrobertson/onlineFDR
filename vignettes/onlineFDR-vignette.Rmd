...
output:
  ...
  pdf_document:
    toc: yes
vignette: |
  %\VignetteIndexEntry{Using the onlineFDR package} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
time of the most recent discovery. This package, onlineFDR, implements these new
