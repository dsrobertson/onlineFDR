...
#' 
#' Implements the Storey-BH algorithm for FDR control, as presented by Storey et. al.(2002).
#' 
#' The function takes as its input either a vector of p-values, or a dataframe
#' with a column of p-values (`pval').
#' 
#' @param d Either a vector of p-values, or a dataframe with the column:
#'  p-value (`pval'). 
#'
...
#'   \eqn{r} is the rank of the \eqn{i}-th p-value within an ordered set and \eqn{n} is
#'   the total number of hypotheses. If hypothesis \eqn{i} is rejected, \code{R[i] = 1}
